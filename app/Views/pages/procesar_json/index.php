        ...
        <table class="table table-striped mb-0">
            ...
            <?php foreach ($groups as $group): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url('procesar-json/descargar-csv/' . $group['id']) ?>" class="btn btn-sm btn-success">Descargar CSV</a>
                        <a href="<?= base_url('procesar-json/descargar-xls/' . $group['id']) ?>" class="btn btn-sm btn-success">Descargar Excel</a>
