...
<div class="container mt-4">
    <h3>🚀 Pruebas Masivas - DTE Nota Dedito (06)</h3>
    <form id="formNotaDebito" class="row g-3">
<?= csrf_field() ?>
        <div class="col-md-3">
...
<script>
    ...
    function ejecutarPruebaSE() {
        ...
        $.getJSON(`<?= base_url('dte/generarNotaDebito') ?>`, { inicio: correlativo, total: 1 }, function (response) {
            ...
            <div class="card mb-3">
                <div class="card-header bg-light">
                    <strong>DTE Nota de Debito #${actual + 1}</strong> - ${dte.identificacion.numeroControl}
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
    ...
    $('#formNotaDebito').on('submit', function (e) {
        e.preventDefault();
    ...
    $('#btnExportar').on('click', function () {
        ...
        a.href = url;
        a.download = `dtes_nota_debito_${new Date().toISOString().slice(0, 19).replace(/[:T]/g, '-')}.json`;
