...
<div class="container mt-4">
    ...
    <h3>🌐 Pruebas Masivas - Factura de Exportación (DTE Tipo 11)</h3>
...
<script>
    ...
    function ejecutarPruebaExportacion() {
        ...
        $.getJSON(`<?= base_url('dte/generarExportacion') ?>`, { inicio: correlativo, total: 1 }, function (response) {
            ...
            <div class="card mb-3">
                <div class="card-header bg-light">
                    <strong>Factura Exportación #${actual + 1}</strong> - ${dte.identificacion.numeroControl}
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
    ...
    $('#btnAuto').on('click', function () {
        ...
        ejecutarPruebaExportacion();
        intervaloID = setInterval(ejecutarPruebaExportacion, intervaloSegundos * 1000);
    });
    ...
    $('#btnExportar').on('click', function () {
        ...
        a.href = url;
        a.download = `dtes_exportacion_resultados_${new Date().toISOString().slice(0, 19).replace(/[:T]/g, '-')}.json`;
