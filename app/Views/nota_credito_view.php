...
<div class="container mt-4">
    <h3>🚀 Pruebas Masivas - DTE Nota Credito (05)</h3>
...
<script>
    ...
    function ejecutarPruebaSE() {
        ...
        $.getJSON(`<?= base_url('dte/generarNotaCredito') ?>`, { inicio: correlativo, total: 1 }, function (response) {
    ...
    $('#btnExportar').on('click', function () {
        ...
        a.href = url;
        a.download = `dtes_nota_credito_${new Date().toISOString().slice(0, 19).replace(/[:T]/g, '-')}.json`;
